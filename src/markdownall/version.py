...
def get_version() -> str:
    ...
    Returns:
        str: The current version string (e.g., "0.6.0")
...
def get_version_info() -> Tuple[int, ...]:
    ...
    Returns:
        Tuple[int, ...]: Version tuple (e.g., (0, 6, 0))
    ...
    try:
        # Remove any pre-release suffixes (e.g., "0.6.0a1" -> "0.6.0")
...
def is_prerelease() -> bool:
    ...
    Example:
        >>> is_prerelease()
        False  # for version "0.6.0"
        True   # for version "0.6.0a1"
    """
    version_str = get_version()
...
def get_version_display() -> str:
    ...
    Returns:
        str: Formatted version string (e.g., "v0.6.0")
    """
...
def compare_version(other_version: str) -> int:
    ...
    Example:
        >>> compare_version("0.5.0")
        1  # current version (0.6.0) is greater
    """
...
A tool for scraping web pages and converting to clean, readable Markdown files.
"""
    return text

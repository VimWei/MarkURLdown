...
class ErrorHandler(QObject):
    ...
    def handle_error(
        self, error: Exception, context: str = "", show_user: bool = True, recoverable: bool = True
    ) -> bool:
        """
    ...
    def _recover_file_not_found(self, context: str) -> bool:
        ...
        try:
            ...
            if "session" in context.lower():
                os.makedirs(self.config_service.config_manager.config_dir, exist_ok=True)
                return True
    ...
    def _recover_permission_error(self, context: str) -> bool:
        ...
        try:
            ...
            if "session" in context.lower():
                config_dir = self.config_service.config_manager.config_dir
    ...
    def _recover_generic_error(self, error_type: str, context: str) -> bool:
        ...
        try:
            ...
            if os.environ.get("PYTEST_CURRENT_TEST") or os.environ.get("QT_QPA_PLATFORM") in {
                "offscreen",
                "headless",
                "minimal",
            }:
    ...
    def get_error_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "recent_errors": len(
                [e for e in self._error_history if now - float(e.get("timestamp", now)) < 3600]
            ),  # Last hour

...
class TestHandlerIntegration:
    ...
    def test_handler_url_patterns(self):
        ...
        # 定义各种URL模式
        url_patterns = {
            "weixin": ["https://mp.weixin.qq.com/s/abc123", "http://mp.weixin.qq.com/s/def456"],
            "zhihu": [
                "https://www.zhihu.com/question/123/answer/456",
                "https://zhuanlan.zhihu.com/p/789",
            ],
            "wordpress": ["https://example.com/wordpress-post", "https://blog.example.com/article"],
            "sspai": ["https://sspai.com/post/123456", "http://sspai.com/post/789012"],
            "nextjs": [
                "https://example.com/nextjs-post",
                "https://blog.example.com/nextjs-article",
            ],
            "generic": ["https://example.com/generic-article", "https://unknown-site.com/article"],
        }
    ...
    def test_handler_error_handling(self):
        """测试处理器错误处理"""
        # 测试各种错误情况
        error_cases = ["网络连接失败", "解析失败", "内容为空", "未知错误"]
    ...
    def test_handler_result_structure(self):
        ...
        # 测试失败结果结构
        failure_result = {"title": None, "content": "", "success": False, "error": "处理失败"}
    ...
    def test_handler_content_filtering(self):
        """测试处理器内容过滤"""
        # 测试需要过滤的内容
        content_to_filter = ["广告内容", "导航菜单", "页脚信息", "侧边栏内容", "评论区域"]
    ...
    def test_handler_integration_workflow(self):
        ...
        workflow = {
            ...
            "processing": {"handler": "generic", "steps": ["fetch", "parse", "convert", "filter"]},
            "output": {
                "title": "测试文章标题",
                "content": "# 测试文章标题\n\n这是文章内容。",
                "success": True,
        ...
        assert workflow["processing"]["handler"] in [
            "weixin",
            "zhihu",
            "wordpress",
            "sspai",

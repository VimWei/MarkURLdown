...
class TestAboutPage:
    ...
    def test_check_for_updates_with_translator(self):
        ...
        with patch('markdownall.ui.pyside.pages.about_page.VersionCheckThread') as mock_thread_class:
            mock_thread = Mock()
            ...
            if mock_thread_class.called:
                mock_thread.update_available.connect.assert_called_once_with(self.about_page.on_update_check_complete)
                mock_thread.finished.connect.assert_called_once_with(self.about_page.on_version_thread_finished)
    ...
    def test_on_update_check_complete_with_translator_up_to_date(self):
        ...
        with patch.object(self.about_page.update_status_label, 'setText') as mock_set_text:
            with patch.object(self.about_page.check_updates_btn, 'setText') as mock_btn_text:
                self.about_page.on_update_check_complete(True, "Current version is up to date", "1.0.0")

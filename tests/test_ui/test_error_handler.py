...
class TestErrorHandler:
    ...
    def setup_method(self):
        ...
        self.mock_config_service.config_manager.sessions_dir = os.path.join(self.temp_dir, "data", "sessions")
    ...
    def test_show_user_error_file_not_found(self):
        ...
        with patch('markdownall.ui.pyside.error_handler.QMessageBox') as mock_msgbox:
            ...
            self.error_handler._show_user_error("FileNotFoundError", "File not found", "test context")
    ...
    def test_show_user_error_connection_error(self):
        ...
        with patch('markdownall.ui.pyside.error_handler.QMessageBox') as mock_msgbox:
            ...
            self.error_handler._show_user_error("ConnectionError", "Network timeout", "test context")
    ...
    def test_show_user_error_exception(self):
        ...
        with patch('markdownall.ui.pyside.error_handler.QMessageBox', side_effect=Exception("MessageBox error")):
            # Should not raise
            self.error_handler._show_user_error("TestError", "Test message", "test context")
    ...
    def test_recover_file_not_found_session(self):
        ...
        with patch('os.makedirs') as mock_makedirs:
            ...
            mock_makedirs.assert_called_once_with(self.mock_config_service.config_manager.sessions_dir, exist_ok=True)
    ...
    def test_recover_permission_error_session(self):
        ...
        with patch('os.path.exists', return_value=True):
            with patch('os.chmod') as mock_chmod:
                ...
                assert result is True
                mock_chmod.assert_called_once_with(self.mock_config_service.config_manager.sessions_dir, 0o755)
    ...
    def test_handle_error_success(self):
        ...
        with patch.object(self.error_handler, '_show_user_error') as mock_show:
            with patch.object(self.error_handler, '_attempt_recovery', return_value=True) as mock_recover:
    ...
    def test_handle_error_exception(self):
        ...
        with patch.object(self.error_handler, 'error_logger', side_effect=Exception("Logger error")):
            with patch('builtins.print') as mock_print:
...
class TestErrorRecovery:
    ...
    def test_recover_from_critical_error_conversion(self):
        ...
        with patch('gc.collect') as mock_gc:
            result = ErrorRecovery.recover_from_critical_error(Exception("Test"), "conversion process")
            assert result is True
            mock_gc.assert_called_once()

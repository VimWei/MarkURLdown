...
def test_sync_ui_from_config_executes(tmp_path):
    ...
    mw.basic_page = Mock()
    mw.webpage_page = Mock()
    mw.advanced_page = Mock()
    mw.command_panel = Mock()
    mw.log_panel = Mock()
    cfg = {
        "basic": {},
        "webpage": {},
    ...
    assert (
        mw.basic_page.set_config.called
        or mw.webpage_page.set_config.called
        or mw.advanced_page.set_config.called
    )

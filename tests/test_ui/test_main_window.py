...
from markdownall.ui.pyside.main_window import MainWindow, Translator, ProgressSignals
...
class TestMainWindow:
    ...
    def setup_method(self):
        ...
        with patch('markdownall.ui.pyside.main_window.BasicPage', return_value=_Stub()), \
    ...
    def test_update_interpolated_progress_with_phase(self):
        ...
        self.main_window._current_images_progress = None
        self.main_window._phase_order = ["phase_fetch_start", "phase_parse_start", "phase_clean_start", "phase_convert_start", "phase_write_start"]
        ...
        with patch('sys.platform', 'win32'):
            with patch('subprocess.run') as mock_run:
                ...
                with patch('platform.system', return_value='Windows'):
                    self.main_window.advanced_page.get_user_data_path = Mock(return_value="/test/path")
    ...
    def test_restore_default_config_exception(self):
        ...
        with patch.object(self.main_window.config_service, 'reset_to_defaults', side_effect=Exception("Reset error")):
